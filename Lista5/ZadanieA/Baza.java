...
public class Baza {
	...
	public void Odczyt() {
		...
		try (ObjectInputStream odczyt = new ObjectInputStream(new FileInputStream("Baza.ser"))) {
			boolean flag = true;
			while(flag) {
	...
	public void Zapis() {
		try (ObjectOutputStream zapis = new ObjectOutputStream(new FileOutputStream("Baza.ser"))) 
		{	
